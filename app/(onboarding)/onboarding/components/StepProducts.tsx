      ...
      <div className="flex flex-col gap-5">
        ...
        {products.length > 0 && (
          <button
            ...
            className="w-full border-2 border-dashed border-border-primary hover:border-brand-400 text-brand-500 hover:text-brand-700 rounded-xl py-3 text-sm font-medium flex items-center justify-center gap-2 transition-colors"
          >
